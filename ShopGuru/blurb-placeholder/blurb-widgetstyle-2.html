					  ...
					  <ul class="nav nav-pills mb-3 wd-tab-menu" id="pills-tab" role="tablist">
						...
						<div class="tab-content" id="pills-tabContent">
							<div class="tab-pane fade active show " id="description-section" role="tabpanel" aria-labelledby="description-tab" aria-expanded="true">
                                ...
                                <div class="proplan-five">
                                    <div class="pro-plan-sin-5">
                                        <div class="row d-flex align-items-center">
                                            <div class="col-lg-5">
                                                <div class="pro-plan-img">
                                                    <img src="img/product-img/mag-tabimg1.jpg" alt="">
                                                </div>
                                            </div>
                                            <div class="col-lg-7">
                                                <div class="pro-plan-con">
                                                    <h2>Vigo SP111-31N-P2GH Spin 1 Details</h2>
                                                    <div class="proplan-rev">
                                                        <div class="one-3">
                                                            8/10
                                                        </div>
                                                        <div class="one-3">
                                                    ...
                                                    <a href="#">SEE PLANS AND PRICING > Wishout</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
