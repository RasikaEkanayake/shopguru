...
<html class="no-js" lang="">
  ...
  <body class="main-home-page review-page">
    <!--[if lt IE 8]>
    ...
    <section id="main-slider-section" class="review-slider-section">
		...
		<div class="container">
			<div class="review-search-slider-section row">
					...
					<div class="col-12 col-lg-10 col-xl-6 slider-search-section">
    ...
    <section id="product-amazon" class="product-shop-page">
    	<div class="container">
    		<div class="row">
				...
				<div class="order-sm-2 order-md-1 col-12 col-md-4 col-lg-3 product-review-desktop-sidebar">
							...
							<div class="filter row">
								...
								<div class="col-6 col-md-6 filter-btn-area text-center">
									 <div class="btn-group" role="group">
									 	<div class="d-flex">
										 	<p>Sort by:</p>
										    <button id="btnGroupDropwdshowresult" type="button" class="btn btn-secondary dropdown-toggle filter-btn" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
										      Default
										    </button>
										    <div class="dropdown-menu" aria-labelledby="btnGroupDropwdshowresult">
