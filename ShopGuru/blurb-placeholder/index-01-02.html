...
<html class="no-js" lang="">
  ...
  <body class="">
    ...
    <!-- =========================
        Header Top Section
    ============================== -->
    <section id="wd-header" class="mob-sticky">
    	<div class="container-fluid custom-width">
    		<div class="row">
    		    <!-- =========================
					Mobile Menu 
    ...
    <section id="main-menu" class="sticker-nav">
    	<div class="container-fluid custom-width">
    		<div class="row">
				...
				<div class="col-6 col-md-4 col-lg-5 text-right ext-right p0 display-none-xl">
							  ...
							  <div class="modal-dialog" role="document">
							    <div class="modal-content">
							      <div class="modal-body">
									<div class="input-group wd-btn-group header-search-option-ph">
    		...
    		<div class="row">
    			<div class="col-6 col-md-6 col-lg-3">
    				<div class="service-box social wow fadeIn animated" data-wow-delay="0.2s">
    					<img src="img/service/social.png" alt="social">
    					<div class="box-text d-flex align-items-center">
    						<h5>Social Business</h5>
    					</div>
    					<div class="hover-img">
    						<img src="img/service/social-bg.png" alt="social">
    					</div>
    				</div>
    			</div>
    			<div class="col-6 col-md-6 col-lg-3">
    		...
    		<div class="row">
    			<div class="col-12">
    				<div class="section-title-center text-left">
    					<h2 class="title pl-0">Market 1 Top Deals</h2>
    				</div>
    			</div>
				<!-- <div class="owl-carousel"> -->
				<div id="product-slider-two" class="owl-carousel owl-theme">
					<div class="item">
						...
						<figure class="figure product-box">
							<div class="product-box-img">
		                                <a href="product-details.php">
		                                    <img src="img/product-img/product-img-3sd.jpg" class="figure-img img-fluid" alt="Product Img">
		                                </a>
							</div>
							<div class="quick-view-btn">
								<div class="compare-btn">
					...
					<div class="item">
						...
						<figure class="figure product-box">
							<div class="product-box-img">
		                                <a href="product-details.php">
		                                    <img src="img/product-img/product-img-v2-3.jpg" class="figure-img img-fluid" alt="Product Img">
		                                </a>
							</div>
							<div class="quick-view-btn">
								<div class="compare-btn">
					...
					<div class="item">
						<figure class="figure product-box">
							<div class="product-box-img">
		                                <a href="product-details.php">
		                                    <img src="img/product-img/product-img-3s.jpg" class="figure-img img-fluid" alt="Product Img">
		                                </a>
							</div>
							<div class="quick-view-btn">
								<div class="compare-btn">
					...
					<div class="item">
						...
						<figure class="figure product-box">
							<div class="product-box-img">
		                                <a href="product-details.php">
		                                    <img src="img/product-img/product-img-v2-6.jpg" class="figure-img img-fluid" alt="Product Img">
		                                </a>
							</div>
							<div class="quick-view-btn">
								<div class="compare-btn">
					...
					<div class="item">
						<figure class="figure product-box">
							<div class="product-box-img">
		                                <a href="product-details.php">
		                                    <img src="img/product-img/product-img-v2-7.jpg" class="figure-img img-fluid" alt="Product Img">
		                                </a>
							</div>
							<div class="quick-view-btn">
								<div class="compare-btn">
						...
						<figure class="figure product-box">
							<div class="product-box-img">
		                                <a href="product-details.php">
		                                    <img src="img/product-img/product-img-v2-8.jpg" class="figure-img img-fluid" alt="Product Img">
		                                </a>
							</div>
							<div class="quick-view-btn">
								<div class="compare-btn">
					...
					<div class="item">
						<figure class="figure product-box">
							<div class="product-box-img">
		                                <a href="product-details.php">
		                                    <img src="img/product-img/product-img-v2-1.jpg" class="figure-img img-fluid" alt="Product Img">
		                                </a>
							</div>
							<div class="quick-view-btn">
								<div class="compare-btn">
					...
					<div class="item">
						<figure class="figure product-box">
							<div class="product-box-img">
		                                <a href="product-details.php">
		                                    <img src="img/product-img/product-img-10.jpg" class="figure-img img-fluid" alt="Product Img">
		                                </a>
							</div>
							<div class="quick-view-btn">
								<div class="compare-btn">
						...
						<figure class="figure product-box">
							<div class="product-box-img">
		                                <a href="product-details.php">
		                                    <img src="img/product-img/product-img-v2-5.jpg" class="figure-img img-fluid" alt="Product Img">
		                                </a>
							</div>
							<div class="quick-view-btn">
								<div class="compare-btn">
				...
				<div class="col-md-7 text-center">
					<div class="wow fadeInUp animated" data-wow-delay="300ms">
						<div class="border-title">
							<h1 class="text-uppercase">MILANCELOS</h1>
						</div>
						<div class="description">
							<p>Pellentesque posuere orci lobortis scelerisque blandit. Donec id tellus lacinia an, tincidunt risus ac, consequat velit. Quisquemos sodales suscipit tortor ditaemcos condimentum lacus meleifend menean viverra auctor </p>
						</div>
						<a href="shop-left-sidebar.php" class="btn btn-primary wd-shop-btn">
							Shop Now <i class="fa fa-arrow-right" aria-hidden="true"></i>
						</a>
					</div>
				</div>
			</div>
				...
				<div id="product-trending-two" class="owl-carousel owl-theme">
	    			<div class="col-md-12">
						<figure class="figure product-box">
							<div class="product-box-img">
                                <a href="product-details.php">
                                    <img src="img/product-img/product-img-v2-9.jpg" class="figure-img img-fluid" alt="Product Img">
                                </a>
							</div>
							<div class="quick-view-btn">
								<div class="compare-btn">
	    			...
	    			<div class="col-md-12">
						<figure class="figure product-box wow fadeIn animated" data-wow-delay="600ms">
							<div class="product-box-img">
		                                <a href="product-details.php">
		                                    <img src="img/product-img/product-img-v2-10.jpg" class="figure-img img-fluid" alt="Product Img">
		                                </a>
							</div>
							<div class="quick-view-btn">
								<div class="compare-btn">
	    			...
	    			<div class="col-md-12">
						<figure class="figure product-box">
							<div class="product-box-img">
		                                <a href="product-details.php">
		                                    <img src="img/product-img/product-img-v2-11.jpg" class="figure-img img-fluid" alt="Product Img">
		                                </a>
							</div>
							<div class="quick-view-btn">
								<div class="compare-btn">
	    			...
	    			<div class="col-md-12">
						<figure class="figure product-box">
							<div class="product-box-img">
                                <a href="product-details.php">
                                    <img src="img/product-img/product-img-v2-12.jpg" class="figure-img img-fluid" alt="Product Img">
                                </a>
							</div>
							<div class="quick-view-btn">
								<div class="compare-btn">
    ...
    <section id="review">
    	<div class="container-fluid custom-width">
    		<div class="row">
    			<div class="col-md-12">
    				<div class="section-title-center text-center">
    					<h2 class="title bg-white">Best Product Review</h2>
    				</div>
    			</div>
    			<div class="col-md-12 col-lg-6">
					<div id="product-review" class="owl-carousel owl-theme product-review wow fadeInLeft animated" data-wow-delay="0ms">
					    <div class="item wd-item">
					    	<img src="img/review/review-img-v2-1.jpg" class="figure-img img-fluid" alt="Product Img">
							<figure class="figure">
								<figcaption class="figure-caption">
									<div class="row">
										<div class="col-md-6 p0 row">
											<div class="col-4 col-md-4">
												<img src="img/review/review-author-img.png" class="figure-img img-fluid" alt="Review Author Image">
											</div>
											<div class="col-8 col-md-8 p0">
												<a href="review-left-sidebar.php" class="author-name">Kitty Yan</a>
												<span class="sub-title">Ceo at <a href="http://www.themeim.com">ThemeIM</a></span>
											</div>
										</div>
										<div class="col-md-6 text-right client-rating">
												...
												<h6 class="inline review-point">4.5</h6>
											<p class="rating-text">Awesome Product</p>
										</div>
										<div class="col-md-12 p0 description">
											<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Alias, distinctio voluptatum quasi, et sed vero optio nesciunt eveniet iure dignissimos illum pariatur cumque doloremque aspernatur aliquam velit totam explicabo odio.Alias, distinctio voluptatum quasi, et sed vero optio nesciunt eveniet iure dignissimos illum pariatur cumque doloremque aspernatur aliquam velit totam explicabo odio.</p>
										</div>
									</div>
								</figcaption>
							</figure>
					    ...
					    <div class="item wd-item">
					    	<img src="img/review/review-img-6.jpg" class="figure-img img-fluid" alt="Product Img">
							<figure class="figure">
								<figcaption class="figure-caption">
									<div class="row">
										<div class="col-md-6 p0 row">
											...
											<div class="col-8 col-md-8 p0">
												<a href="review-left-sidebar.php" class="author-name">Shopi Monacrk</a>
												<span class="sub-title">Ceo at <a href="http://www.themeim.com">ThemeIM</a></span>
											</div>
										</div>
										<div class="col-md-6 text-right client-rating">
												...
												<h6 class="inline review-point">5</h6>
											<p class="rating-text">Awesome Product</p>
										</div>
										<div class="col-md-12 p0 description">
    			...
    			<div class="col-md-12 col-lg-6">
					...
					<div data-video="cBNBnpmyGM0" id="video" class="wow fadeInRight animated" data-wow-delay="0ms">
					  <img class="figure-img img-fluid" src="img/02.jpg" alt="Use your own screenshot.">
					</div>
    			</div>
    		</div>
    	</div>
    		...
    		<div class="row">
    			...
    			<div class="col-12 col-md-6 col-lg-6 col-xl-3">
					<figure class="figure blog-box wow fadeInUp animated" data-wow-delay="300ms">
						<img src="img/blog/blog-img-v2-1.jpg" class="figure-img img-fluid" alt="blog-img">
						<figcaption class="figure-caption">
						<div class="mata-info">
							<ul>
								<li>
							...
							<a class="blog-title" href="single-blog-with.php">
    			...
    			<div class="col-12 col-md-6 col-lg-6 col-xl-3">
					<figure class="figure blog-box wow fadeInUp animated" data-wow-delay="600ms">
						<img src="img/blog/blog-img-v2-2.jpg" class="figure-img img-fluid" alt="blog-img">
						<figcaption class="figure-caption">
						<div class="mata-info">
							<ul>
								<li>
    			...
    			<div class="col-12 col-md-6 col-lg-6 col-xl-3">
					<figure class="figure blog-box wow fadeInUp animated" data-wow-delay="900ms">
						<img src="img/blog/blog-img-v2-3.jpg" class="figure-img img-fluid" alt="blog-img">
						<figcaption class="figure-caption">
						<div class="mata-info">
							<ul>
								<li>
    			...
    			<div class="col-12 col-md-6 col-lg-6 col-xl-3">
					<figure class="figure blog-box wow fadeInUp animated" data-wow-delay="1200ms">
						<img src="img/blog/blog-img-v2-4.jpg" class="figure-img img-fluid" alt="blog-img">
						<figcaption class="figure-caption">
						<div class="mata-info">
							<ul>
								<li>
    ...
    <section id="call-to-action">
    	<div class="container-fluid custom-width">
    		<div class="row">
    			<div class="col-md-6">
    				<h2 class="call-to-action-message wow bounceInRight animated" data-wow-delay="300ms">The most happy <span class="bold-font">Comparison</span> theme to Build with great <span class="bold-font">Features.</span></h2>
    			</div>
    			<div class="col-md-6 text-right">
    				<div class="call-to-action-buy-now wow bounceInRight animated" data-wow-delay="600ms">
    					<!-- By Theme -->
