...
<html class="no-js" lang="">
  ...
  <body class="">
        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-8 col-sm-6 ">
                    <img src="img/slider-img/404-fun.png" alt="">
                </div>
                <div class="col-12 col-sm-6">
                    <div class="four-0-inner">
                        ...
                        <a class="go-back" href="index.php"><i class="fa fa-arrow-left" aria-hidden="true"></i>Go Back</a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <!-- =========================
        Subscribe Section
    ============================== -->
    <section id="subscribe" class="four-zero-page">
    	<div class="container">
    ...
    <!-- =========================
        Footer Section
    ============================== -->
    <footer class="footer four-zero-page wow fadeInUp animated" data-wow-delay="900ms">
    	<div class="container">
    		<div class="row">
    			<div class="col-md-3">
    				<!-- ===========================
