		...
		<div class="container">
			<div class="review-search-slider-section row justify-content-center">
                <div class="col-12 col-lg-12">
                    <h1 class="review-slider-title">Shortcode for review</h1>
                </div>
            </div>
		</div>
    </section>
    		...
    		<div class="row">
    			<div class="col-md-12">
    				<div class="section-title-center text-center">
    					<h2 class="title bg-white">Shortcode for Review Style One</h2>
    				</div>
    			</div>
    			<div class="col-md-12 col-lg-6">
					<div id="product-review" class="owl-carousel owl-theme product-review wow fadeInLeft animated" data-wow-delay="0ms">
					    <div class="item wd-item">
					    	<img src="img/review/review-img-1.jpg" class="figure-img img-fluid" alt="Product Img">
							<figure class="figure">
									...
									<div class="row">
										<div class="col-md-6 p0 row">
											...
											<div class="col-8 col-md-8 p0">
												<a href="review-left-sidebar.php" class="author-name">Robert Strud</a>
								...
								<figcaption class="figure-caption">
									<div class="row">
										<div class="col-md-6 p0 row">
											...
											<div class="col-8 col-md-8 p0">
												<a href="review-left-sidebar.php" class="author-name">Faisal Kanon</a>
												<span class="sub-title">CEO at <a href="http://www.wditsolution.com/">WD IT SOLUTION</a></span>
											</div>
										</div>
										<div class="col-md-6 text-right client-rating">
												<div class="rating inline">
    			...
    			<div class="col-md-12 col-lg-6">
					...
					<div data-video="cBNBnpmyGM0" id="video" class="wow fadeInRight animated" data-wow-delay="0ms">
					  <img class="figure-img img-fluid" src="img/0.jpg" alt="Use your own screenshot.">
					</div>
    			</div>
    		</div>
    	</div>
    	...
    	<div class="container">
    		<div class="row">
				...
				<div class="wd-tab-section">
					...
					<div class="tab-pane reviews-section reviews" >
						<div class="row">
							<div class="col-12">
								<div class="reviews-market">
									...
									<div class="star-view-market">
										<div class="row">
											...
											<div class="col-6 col-md-3 col-lg-2">
												<img src="img/client/reviews-star-img2.png" alt="client-img">
											...
											<div class="col-6 col-md-3 col-lg-2">
												<img src="img/client/reviews-star-img3.png" alt="client-img">
												<span class="badge badge-secondary wd-star-market-badge text-uppercase">4.5</span>
												<div class="rating-market-section">
													<div class="rating-star">
											...
											<div class="col-6 col-md-3 col-lg-2">
												<img src="img/client/reviews-star-img4.png" alt="client-img">
												<span class="badge badge-secondary wd-star-market-badge text-uppercase">4.5</span>
												<div class="rating-market-section">
													<div class="rating-star">
											...
											<div class="col-6 col-md-3 col-lg-2">
												<img src="img/client/reviews-star-img5.png" alt="client-img">
												<span class="badge badge-secondary wd-star-market-badge text-uppercase">4.5</span>
												<div class="rating-market-section">
													<div class="rating-star">
											...
											<div class="col-6 col-md-3 col-lg-2">
												<img src="img/client/reviews-star-img6.png" alt="client-img">
												<span class="badge badge-secondary wd-star-market-badge text-uppercase">4.5</span>
												<div class="rating-market-section">
													<div class="rating-star">
													...
													<div class="row">
														<div class="col-12">
															<div class="media">
															  ...
															  <div class="media-body">
															    <h4 class="media-heading client-title">Mohammad Shohag</h4>
