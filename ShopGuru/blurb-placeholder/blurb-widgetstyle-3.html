						...
						<div class="tab-content" id="pills-tabContent">
							<div class="tab-pane fade active show " id="description-section" role="tabpanel" aria-labelledby="description-tab" aria-expanded="true">
								<div class="product-tab-content">
                                    ...
                                    <div class="link-style-four">
                                        <div class="container-fluid">
                                            <div class="row justify-content-center">
                                                <div class="col-xl-8 ">
                                                   <div class="ls-4wrapper d-sm-flex align-items-center">
                                                      <div class="ls-4img f1">
                                                          <img src="img/product-img/th-product-img-1.jpg" alt="">
                                                      </div>
                                                      <h3 class="ls-title f2">Vigo SP111-31N-P2GH Spin 1 Details</h3>
                                                      <div class="ls-4img-right f3">
                                                          <h6>$600</h6>
                                                          <a href="#" class="aff-buynow">Buy now</a>
                                                          <a href="#"><img src="img/icon/amazon2.png" alt=""></a>
                                                      </div>
