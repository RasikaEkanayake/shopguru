...
<html class="no-js" lang="">
  ...
  <body class="">
    ...
    <!-- =========================
        Header Top Section
    ============================== -->
    <section id="wd-header" class="style-four mob-sticky dark-header">
    	<div class="container-fluid custom-width">
    		<div class="row d-flex align-items-center">
    		    <!-- =========================
					Mobile Menu 
				============================== -->
    		    <div class="order-2 order-sm-1 col-3 col-sm-2 col-md-4 d-block d-lg-none">
    			...
    			<div class="order-1 order-sm-2  col-12 col-sm-5 col-md-4 col-lg-2 col-xl-2">
				...
				<!-- =========================
					 Login and My Acount 
				============================== -->
				<div class="order-3 order-sm-3 col-9 col-sm-5 col-lg-4 col-md-4 col-xl-5">
					<!-- =========================
						 User Account Section
                ============================== -->
                    <div class="header-banner d-flex align-items-center ">
                       <a href="shop-left-sidebar.php" class="btn btn-primary wd-shop-btn ml-auto">Buy now</a>
                    </div>
                    <div class="acc-header-wraper d-md-block d-lg-none">
						...
						<!-- ========================= Cart Out ============================== -->
						 <div class="header-cart style-four">
								<a class="header-wishlist" href="wishlist.php">
									<i class="fa fa-heart-o" aria-hidden="true"></i>
								</a>
								<div class="dropdown wd-compare-btn">
								  <button class="btn btn-secondary dropdown-toggle compare-btn" type="button" id="dropdowenu2" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
								  ...
								  <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenu2">
								  	...
								  	<div class="media text-center">
										<a href="compare-products.php" class="btn btn-primary go-compare-page">Compare <i class="fa fa-arrow-right" aria-hidden="true"></i></a>
									</div>
								  </div>
								</div>
							</div>
    ...
    <!-- =========================
        Main Menu Section
    ============================== -->
    <section id="main-menu" class="sticker-nav style-four double-bg">
    	<div class="container-fluid custom-width">
    		<div class="row">
    			<div class="cus-wd-l p0 angle">
				...
				<div class="cus-wd-r text-right ext-right p0">
                                                                        ...
                                                                        <div class="login-form text-left">
                                                                            <form>
                                                                                <div class="form-group">
                                                                                    ...
                                                                                    <input class="form-control" id="exampleInputEmail-login" placeholder="John mist |" type="text">
                                                                                </div>
                                                                                <div class="form-group">
                                                                                    <label for="exampleInputPassword-login-pass-2">Password</label>
                                                                                    <input class="form-control" id="exampleInputPassword-login-pass-2" placeholder="*** *** ***" type="password">
                                                                                </div>
                                                                        ...
                                                                        <div class="login-form text-left">
                                                                            <form>
                                                                                <div class="form-group">
                                                                                    ...
                                                                                    <input class="form-control" id="exampleInputname1" placeholder="First Name" type="text">
                                                                                </div>
                                                                                <div class="form-group">
                                                                                    <label for="exampleInputname2">Last name</label>
                                                                                    <input class="form-control" id="exampleInputname2" placeholder="Last Name" type="text">
                                                                                </div>
                                                                                <div class="form-group">
                                                                                    <label for="exampleInputEmail-sign-up">Email</label>
                                                                                    <input class="form-control" id="exampleInputEmail-sign-up" placeholder="Enter you email ..." type="text">
                                                                                </div>
                                                                                <div class="form-group">
                                                                                    <label for="exampleInputPassword-login-pass">Password</label>
                                                                                    <input class="form-control" id="exampleInputPassword-login-pass" placeholder="*** *** ***" type="password">
                                                                                </div>
				...
				<!-- =========================
					 Cart Out 
				============================== -->
				<div class="col-4 col-md-2 col-lg-1 text-right p0 d-md-none display-none-xl">
					<div class="header-cart">
						<a class="header-wishlist" href="#">
							<i class="fa fa-heart-o" aria-hidden="true"></i>
						</a>
						<div class="dropdown wd-compare-btn">
						  <button class="btn btn-secondary dropdown-toggle compare-btn" type="button" id="dropdownMenu-cart" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
						    <img src="img/cart.png" alt="cart">
						  </button>
						  <span class="count">5</span>
						  <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenu-cart">
						  	<div class="wd-item-list">
							  	<div class="media">
									<img class="d-flex mr-3" src="img/cart-img-1.jpg" alt="cart-img">
									<div class="media-body">
    ...
    <!-- =========================
        Magazine fullwidt carousel Section
    ============================== -->
    ...
    <section class="full-carousel">
        <div class="fullwidth-carousel owl-carousel owl-theme">
            ...
            <div class="sin-fw-carousel item">
                <img src="img/blog-img/mag-fw1.jpg" alt="">
                <div class="full-width-con">
                    ...
                    <div class="bot-cont">
                        <h2>$99</h2>
                        <a href="#">Smartphone - J2 (2016) - 5" - 1.5GB RAM 
8GB ROM - 8MP Camera - Gold</a>
                    </div>
                    <div class="bottom-line">
                        <h2><a href="">Deals Based on Review</a></h2>
                    </div>
                </div>
            </div>
                   
            <div class="sin-fw-carousel item">
                <img src="img/blog-img/mag-fw2.jpg" alt="">
                <div class="full-width-con">
                    <div class="top-content">
                        <h6>Hot Deals</h6>
                        <div class="rating">
...
8GB ROM - 8MP Camera - Gold</a>
                    ...
                    <div class="bottom-line">
                        <h2><a href="">Compare</a></h2>
                    </div>
                </div>
            </div>
                   
            <div class="sin-fw-carousel item">
                <img src="img/blog-img/mag-fw3.jpg" alt="">
                <div class="full-width-con">
                    <div class="top-content">
                        <h6>Unlock</h6>
                        <div class="rating">
...
8GB ROM - 8MP Camera - Gold</a>
            ...
            <div class="sin-fw-carousel item">
                <img src="img/blog-img/mag-fw4.jpg" alt="">
                <div class="full-width-con">
                    <div class="top-content">
                        <h6>Black Friday</h6>
                        <div class="rating">
...
8GB ROM - 8MP Camera - Gold</a>
            ...
            <div class="sin-fw-carousel item">
                <img src="img/blog-img/mag-fw5.jpg" alt="">
                <div class="full-width-con">
                    <div class="top-content">
                        <h6>Best Match</h6>
                        <div class="rating">
...
8GB ROM - 8MP Camera - Gold</a>
      ...
      <!-- =========================
        Magazine tab  Section
    ============================== -->
    <section class="tab-magazine recent-pro-2">
        <div class="container-fluid custom-width">
            <div class="row">
               <div class="col-lg-8 col-xl-6">
                   <div class="tab-maga-wrapper">
                  ...
                  <div class="tab-content" id="myTabContent-recent">
						<div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                            <div class="magazine-sin">
                                <img src="img/blog-img/mag-tab1.jpg" alt="">
                                <div class="magazine-tab-con">
                                    <h2>Featured deals in <br>Mobiles &<span>Accessories</span></h2>
                                    <p><span>$1189</span> - $356</p>
                                    <div class="tab-bottom">
                                        <h3><a href="#">OnePlus 5T (Midnight Black 6GB RAM + 64GB memory)</a></h3>
               ...
               <div class="col-lg-4 col-xl-6">
                   <div class="row">
                       <div class="col-xl-8">
                           <div class="c-area-wrapper">
                                <div class="sin-tab-pro">
                                    <div class="st-img">
                                        <img src="img/product-img/mag-tabs1.jpg" alt="">
                                    </div>
                                    <div class="tp-content">
                                        <a href="#">HTC Desire 530 and Scorebox example</a>
                                        <div class="rating">
                                            <a href="#"><i class="fa fa-star active-color" aria-hidden="true"></i></a>
                                            <a href="#"><i class="fa fa-star active-color" aria-hidden="true"></i></a>
                                            <a href="#"><i class="fa fa-star active-color" aria-hidden="true"></i></a>
                                        ...
                                        <p>October 28, 2016 2 comments</p>
                                    </div>
                                </div>
                                
                                <div class="sin-tab-pro">
                                    <div class="st-img">
                                        <img src="img/product-img/mag-tabs2.jpg" alt="">
                                    </div>
                                    <div class="tp-content">
                                        <a href="#">LG K7 and combined Content Egg</a>
                                        <div class="rating">
                                            <a href="#"><i class="fa fa-star active-color" aria-hidden="true"></i></a>
                                            <a href="#"><i class="fa fa-star active-color" aria-hidden="true"></i></a>
                                            <a href="#"><i class="fa fa-star active-color" aria-hidden="true"></i></a>
                                ...
                                <div class="sin-tab-pro">
                                    <div class="st-img">
                                        <img src="img/product-img/mag-tabs3.jpg" alt="">
                                    </div>
                                    <div class="tp-content">
                                        <a href="#">Samsung galaxy S7 and how to divide </a>
                                        <div class="rating">
                                            <a href="#"><i class="fa fa-star active-color" aria-hidden="true"></i></a>
                                            <a href="#"><i class="fa fa-star active-color" aria-hidden="true"></i></a>
                                            <a href="#"><i class="fa fa-star active-color" aria-hidden="true"></i></a>
                       ...
                       <div class="col-xl-4 d-md-none d-xl-block">
                           <div class="mag-add">
                              <a href="#"><img src="img/product-img/mag-add.jpg" alt=""></a>
                           </div>
                       </div>
                   </div>
               </div>
    ...
    <section class="maz-blog">
        <div class="container-fluid custom-width">
            <div class="row">
                <div class="col-sm-6 col-md-4 col-xl-3">
                    <div class="mag-sin-blog">
                       <div class="mag-sinb-img">
                           <img src="img/product-img/mag-rev2.jpg" alt="">
                        <div class="mag-blog-tag">
                            <a href="#">Shop</a>
                            <a href="#">e-commerce</a>
                            <a href="#">Affiliate</a>
                        </div>
                        ...
                        <div class="mag-blog-content">
                           <p>supervendor  October 28 . 2016</p>
                           <h2><a href="#">Photo 550 and Scorebox review example</a></h2>
                           <p class="mag-blog-con">
                               This is example of scorebox shortcode in widget. You can find parameters here It has introduced a new storage option though, with a 32GB model now ...
                           </p>
                ...
                <div class="col-sm-6 col-md-4 col-xl-3">
                    <div class="mag-sin-blog">
                       <div class="mag-sinb-img">
                           <img src="img/product-img/mag-rev1.jpg" alt="">
                        <div class="mag-blog-tag">
                            <a href="#">Shop</a>
                            <a href="#">e-commerce</a>
                            <a href="#">Affiliate</a>
                ...
                <div class="col-sm-6 col-md-4 col-xl-3">
                    <div class="mag-sin-blog">
                       <div class="mag-sinb-img">
                           <img src="img/product-img/mag-rev3.jpg" alt="">
                        <div class="mag-blog-tag">
                            <a href="#">Shop</a>
                            <a href="#">e-commerce</a>
                            <a href="#">Affiliate</a>
                ...
                <div class="col-sm-6 col-md-12 col-xl-3">
                   <div class="blog-right-sin">
                       <img src="img/product-img/mag-rev4.jpg" alt="">
                       <div class="blog-right-sin-con">
                           <a href="#">HTC Desire 530 and Scorebox example</a>
                           <p>supervendor  October 28 . 2016</p>
                       </div>
                   </div>
                   ...
                   <div class="blog-right-sin">
                       <img src="img/product-img/mag-rev5.jpg" alt="">
                       <div class="blog-right-sin-con">
                           <a href="#">HTC Desire 530 and Scorebox example</a>
                           <p>supervendor  October 28 . 2016</p>
                       </div>
        ...
        <div class="container-fluid custom-width">
            ...
            <div class="row ">
                <div class="col-sm-6 col-md-3 col-xl-3">
                    <div class="sin-pro-ban">
                        <img src="img/product-img/mag-tabimg1.jpg" alt="">
                        <div class="pro-ban-con">
                            <a href="#">Alienware AW2518H 240Hz G-Sync Monitor Review</a>
                            <p>Supervendor  October 28 . 2016</p>
                        </div>
                    </div>
                </div>
                <div class="col-sm-6 col-md-3 col-xl-3">
                    <div class="sin-pro-ban">
                        <img src="img/product-img/mag-tabimg2.jpg" alt="">
                        <div class="pro-ban-con">
                            <a href="#">Star Wars Battlefront II Performance Review</a>
                            <p>Supervendor  October 28 . 2016</p>
                        </div>
                    </div>
                </div>
                <div class="col-sm-6 col-md-3 col-xl-3">
                    <div class="sin-pro-ban">
                        <img src="img/product-img/mag-tabimg3.jpg" alt="">
                        <div class="pro-ban-con">
                            <a href="#">Antec P110 Luce Case Review Is it necessary</a>
                            <p>Supervendor  October 28 . 2016</p>
                        </div>
                    </div>
                </div>
                <div class="col-sm-6 col-md-3 col-xl-3">
                   <div class="mag-add">
                       <a href="#"><img src="img/product-img/mag-add2.jpg" alt=""></a>
                   </div>
    ...
    <!-- =========================
        Product and Banner  Section two
    ============================== -->
    
    <section class="Pro-and-banner mar-top-minus">
        <div class="container-fluid custom-width">
            <div class="row">
                <div class="col-md-3 col-xl-3 d-sm-none d-md-block">
                   <div class="mag-add">
                       <a href="#"><img src="img/product-img/mag-add3.jpg" alt=""></a>
                   </div>
                    
                </div>
                <div class="col-md-9">
                    <h1>Best Review of the week</h1>
                    <div class="row justify-content-center">
                        <div class="col-sm-6 col-md-4 col-xl-4">
                            <div class="sin-pro-ban">
                                <img src="img/product-img/mag-tabimg4.jpg" alt="">
                                <div class="pro-ban-con">
                                    <a href="#">Alienware AW2518H 240Hz G-Sync Monitor Review</a>
                                    <p>Supervendor October 28 . 2016</p>
                                </div>
                        ...
                        <div class="col-sm-6 col-md-4 col-xl-4">
                            <div class="sin-pro-ban">
                                <img src="img/product-img/mag-tabimg5.jpg" alt="">
                                <div class="pro-ban-con">
                                    <a href="#">Star Wars Battlefront II Performance Review</a>
                                    <p>Supervendor October 28 . 2016</p>
                                </div>
                        ...
                        <div class="col-sm-6 col-md-4 col-xl-4">
                            <div class="sin-pro-ban">
                                <img src="img/product-img/mag-tabimg6.jpg" alt="">
                                <div class="pro-ban-con">
                                    <a href="#">Antec P110 Luce Case Review Is it necessary</a>
                                    <p>Supervendor October 28 . 2016</p>
                                </div>
    ...
    <!-- =========================
        Product and Banner  Section three
    ============================== -->
    
    <section class="Pro-and-banner pad-top-30">
        <div class="container-fluid custom-width">
            <div class="row">
                <div class="col-md-9">
                    <h1>Best Blurb store of the week</h1>
                    <div class="row justify-content-center">
                        <div class="col-sm-6 col-md-4 col-xl-4">
                            <div class="sin-pro-ban">
                                <img src="img/product-img/mag-tabimg7.jpg" alt="">
                                <div class="pro-ban-con">
                                    <a href="#">Alienware AW2518H 240Hz G-Sync Monitor Review</a>
                                    <p>Supervendor October 28 . 2016</p>
                                </div>
                        ...
                        <div class="col-sm-6 col-md-4 col-xl-4">
                            <div class="sin-pro-ban">
                                <img src="img/product-img/mag-tabimg8.jpg" alt="">
                                <div class="pro-ban-con">
                                    <a href="#">Star Wars Battlefront II Performance Review</a>
                                    <p>Supervendor October 28 . 2016</p>
                                </div>
                        ...
                        <div class="col-sm-6 col-md-4 col-xl-4">
                            <div class="sin-pro-ban">
                                <img src="img/product-img/mag-tabimg9.jpg" alt="">
                                <div class="pro-ban-con">
                                    <a href="#">Antec P110 Luce Case Review Is it necessary</a>
                                    <p>Supervendor October 28 . 2016</p>
                                </div>
                ...
                <div class="col-md-3">
                   <div class="mag-add">
                       <a href="#"><img src="img/product-img/mag-add4.jpg" alt=""></a>
                   </div>
            ...
            <div class="row">
                <div class="col-sm-6 col-md-6 col-xl-3">
                    <div class="sin-mag-rev">
                        <div class="mr-img">
                            <img src="img/product-img/product-img-17.jpg" alt="">
                        </div>
                ...
                <div class="col-sm-6 col-md-6 col-xl-3">
                    <div class="sin-mag-rev">
                        <div class="mr-img">
                            <img src="img/product-img/product-img-12.jpg" alt="">
                        </div>
                        <div class="mag-rev-con">
                            <div class="mr-meta">
                                <a href="#"><i class="fa fa-comments-o" aria-hidden="true"></i>226 Comments</a>
                ...
                <div class="col-sm-6 col-md-6 col-xl-3">
                    <div class="sin-mag-rev">
                        <div class="mr-img">
                            <img src="img/product-img/product-img-16.jpg" alt="">
                        </div>
                        <div class="mag-rev-con">
                            <div class="mr-meta">
                                <a href="#"><i class="fa fa-comments-o" aria-hidden="true"></i>226 Comments</a>
                ...
                <div class="col-sm-6 col-md-6 col-xl-3">
                    <div class="sin-mag-rev">
                        <div class="mr-img">
                            <img src="img/product-img/product-img-15.jpg" alt="">
                        </div>
                        <div class="mag-rev-con">
                            <div class="mr-meta">
                                <a href="#"><i class="fa fa-comments-o" aria-hidden="true"></i>226 Comments</a>
    ...
    <section class="pro-carousel">
        <div class="pro-carousel-start owl-carousel owl-theme">
           <!--single carousel-->
            <div class="item sin-pc">
                <img src="img/product-img/ps1.jpg" alt="">
                <a href="#">8 Things You Should Never Do in Paris</a>
            </div>
            <!--single carousel-->
            <div class="item sin-pc">
                <img src="img/product-img/ps2.jpg" alt="">
                <a href="#">End Your Nightly Snoring Nightmare</a>
            </div>
            <!--single carousel-->
            <div class="item sin-pc">
                <img src="img/product-img/ps3.jpg" alt="">
                <a href="#">21 Extremely Funny Thoughts To Celebrate</a>
            </div>
            <!--single carousel-->
            <div class="item sin-pc">
                <img src="img/product-img/ps4.jpg" alt="">
                <a href="#">Hilary Duff Shows Off Her Flat Stomach</a>
            </div>
            <!--single carousel-->
            <div class="item sin-pc">
                <img src="img/product-img/ps5.jpg" alt="">
                <a href="#">Hilary Duff Shows Off Her Flat Stomach</a>
            </div>
            <!--single carousel-->
            <div class="item sin-pc">
                <img src="img/product-img/ps6.jpg" alt="">
                <a href="#">8 Things You Should Never Do in Paris</a>
            </div>
            <!--single carousel-->
            <div class="item sin-pc">
                <img src="img/product-img/ps7.jpg" alt="">
                <a href="#">Watch Out. This Girl Knows to Sell Videos</a>
            </div>
            <!--single carousel-->
            <div class="item sin-pc">
                <img src="img/product-img/ps8.jpg" alt="">
                <a href="#">Hilary Duff Shows Off Her Flat Stomach</a>
            </div>
            <!--single carousel-->
            <div class="item sin-pc">
                <img src="img/product-img/ps9.jpg" alt="">
                <a href="#">Hilary Duff Shows Off Her Flat Stomach</a>
            </div>
            <!--single carousel-->
            <div class="item sin-pc">
                <img src="img/product-img/ps10.jpg" alt="">
                <a href="#">21 Extremely Funny Thoughts To Celebrate</a>
            </div>
    ...
    <!-- =========================
        Footer Fullwidth social area
    ============================== -->
    
    <section class="footer-full-social">
        <div class="container custom-width">
           <div class="row">
                <div class="col-6 col-sm-6 col-md-4 col-xl-2">
                    <div class="sin-fw-social fb-fw">
                       <a href="#"><i class="fa fa-facebook" aria-hidden="true"></i>Facebook</a>
                    </div>
                </div>
                
                <div class="col-6 col-sm-6 col-md-4 col-xl-2">
                    <div class="sin-fw-social tw-fw">
                       <a href="#"><i class="fa fa-twitter" aria-hidden="true"></i>Twitter</a>
                    </div>
                </div>
                
                <div class="col-6 col-sm-6 col-md-4 col-xl-2">
                    <div class="sin-fw-social ins-fw">
                       <a href="#"><i class="fa fa-instagram" aria-hidden="true"></i>Instagram</a>
                    </div>
                </div>
                
                <div class="col-6 col-sm-6 col-md-4 col-xl-2">
                    <div class="sin-fw-social lin-fw">
                       <a href="#"><i class="fa fa-linkedin-square" aria-hidden="true"></i>Linkedin</a>
                    </div>
                </div>
                
                <div class="col-6 col-sm-6 col-md-4 col-xl-2">
                    <div class="sin-fw-social tum-fw">
                       <a href="#"><i class="fa fa-tumblr-square" aria-hidden="true"></i>Tumblr</a>
                    </div>
                </div>
                
                <div class="col-6 col-sm-6 col-md-4 col-xl-2">
                    <div class="sin-fw-social red-fw">
                       <a href="#"><i class="fa fa-reddit" aria-hidden="true"></i>Reddit</a>
                    </div>
                </div>
