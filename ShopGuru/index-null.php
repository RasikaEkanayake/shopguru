    	...
    	<div class="container">
    		<div class="row">
				...
				<div id="product-slider" class="owl-carousel owl-theme">
	    			...
	    			<div class="col-md-12">
						<figure class="figure product-box wow fadeIn animated" data-wow-delay="300ms">
							<div class="product-box-img">
								<a href="product-details.php">
	    			...
	    			<div class="col-md-12">
						<figure class="figure product-box">
							<div class="product-box-img">
								<a href="product-details.php">
									<img src="img/product-img/product-img-7.jpg" class="figure-img img-fluid" alt="Product Img">
								</a>
							</div>
							<div class="quick-view-btn">
								<div class="compare-btn">
    ...
    <section id="product-ebay">
    	<div class="container">
    		<div class="row">
    			<div class="col-md-12">
    				<div class="section-title-center text-left">
    					<h2 class="title pl-0">Market 2 Top Deals</h2>
    				</div>
    			</div>
    		...
    		<div class="row">
    			...
    			<div class="col-md-4">
					<figure class="figure blog-box wow fadeInUp animated" data-wow-delay="300ms">
						<img src="img/blog/blog-img-1.jpg" class="figure-img img-fluid" alt="blog-img">
						<figcaption class="figure-caption">
						<div class="mata-info">
							<ul>
								<li>
    			...
    			<div class="col-md-4">
					<figure class="figure blog-box wow fadeInUp animated" data-wow-delay="600ms">
						<img src="img/blog/blog-img-2.jpg" class="figure-img img-fluid" alt="blog-img">
						<figcaption class="figure-caption">
						<div class="mata-info">
							<ul>
								<li>
    			...
    			<div class="col-md-4">
					<figure class="figure blog-box wow fadeInUp animated" data-wow-delay="900ms">
						<img src="img/blog/blog-img-3.jpg" class="figure-img img-fluid" alt="blog-img">
						<figcaption class="figure-caption">
						<div class="mata-info">
							<ul>
								<li>
