...
<!-- 
                                        ...
                                        <div class="wd-sub-list">
                                            <div class="container">
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6">
                                                        <a href="product-details-scroll.php"><img src="img/department-img/department-sub-list-img-1.jpg" class="department-sub-list-img" alt="department-sub-list-img"></a>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <a href="product-details-scroll.php"><img src="img/department-img/department-sub-list-img-2.jpg" class="department-sub-list-img" alt="department-sub-list-img"></a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    </li>
                                    <li class="list-group-item"><a href="product-details-scroll.php">
                                        <div class="department-list-logo">
                            ...
                            <div class="menu-container wd-megamenu text-left">
                                <div class="menu">
                                    <ul class="wd-megamenu-ul">
                                        <li><a href="index.php" class="main-menu-list"><i class="fa fa-home" aria-hidden="true"></i> Home Page </a>
                                        </li>
                                    ...
                                    <ul class="single-dropdown megamenu">
                                        ...
                                        <li><a href="blog-four-grid-left-sidebar.php" class="main-menu-list">Blog</a>
                                            <ul class="single-dropdown">
                                                <li><a href="blog-full-grid.php">Blog Full Grid</a></li>
                                                <li><a href="blog-two-grid.php">Blog Two Grid</a></li>
                                                <li><a href="blog-three-grid.php">Blog Three Grid</a></li>
				...
				<div class="container-fluid">
					<div class="row justify-content-end">
						...
						<div class="slider-text col-sm-6  col-xl-4   col-md-6 order-2 order-sm-1">
							...
							<a href="shop-left-sidebar.php" class="btn btn-primary wd-shop-btn slider-btn">
	...
	<section class="magazine-top">
        <div class="container-fluid custom-width">
           <div class="row">
               <div class="col-lg-2 col-xl-2 d-md-none d-xl-block">
                  <div class="mag-left-banner">
                      <img src="img/product-img/mag-left-banner.png" alt="">
                      <a href="shop-left-sidebar.php" class="btn btn-primary wd-shop-btn">Shop Now</a>
                  </div>
               </div>
                <div class="col-lg-12 col-xl-10 ">
                    <!--Holiday deals area start-->
                    <div class="holiday-deals">
                        <div class=" row d-flex  align-items-center">
                            <div class="order-2 order-sm-1 col-lg-12 col-xl-2">
                                <h6>Your Holiday Deals</h6>
                            </div>
                            <div class="order-3 order-sm-2 col-12 col-sm-8 col-md-9 col-lg-9 col-xl-7">
                               <!--Single holiday car-->
                                <div class="holiday-carousel owl-carousel owl-theme">
                                   
                                    <div class="sin-hol-car item">
                                       <a href="#">
                                          <div class="hc-l">
                                            <p>SK hynix SL308</p>
                                            <p>2.5" 500GB</p>
                                        ...
                                        <div class="hc-r">
                                            <img src="img/product-img/deal-pro1.png" alt="">
                                        </div>
                                    ...
                                    <div class="sin-hol-car item">
                                       <a href="">
                                        ...
                                        <div class="hc-r">
                                            <img src="img/product-img/deal-pro2.png" alt="">
                                        </div>
                                    ...
                                    <div class="sin-hol-car item">
                                       <a href="#">
                                        ...
                                        <div class="hc-r">
                                            <img src="img/product-img/deal-pro3.png" alt="">
                                        </div>
                                    ...
                                    <div class="sin-hol-car item">
                                       <a href="#">
                                        ...
                                        <div class="hc-r">
                                            <img src="img/product-img/deal-pro4.png" alt="">
                                        </div>
                                       </a>
                                    </div>
                            ...
                            <div class="order-1 order-sm-3 col-12 col-sm-4 col-md-3 col-lg-3 col-xl-3 ">
                                <div class="notice-board">
                                   <a href=""><img src="img/icon/notice.png" alt=""></a>
                                </div>
                            </div>
                        </div>
                    </div>
                    <!--Holiday deals area end-->
                    <!--Magazine Big offer start-->
                    <div class="big-offer ">
                        <div class="sin-big-offer n1">
                            <img src="img/product-img/big-deal1.png" alt="">
                            <a href="shop-left-sidebar.php" class="btn btn-primary wd-shop-btn pos-1">Shop Now</a>
                        </div>
                        
                        <div class="sin-big-offer mar-left n2">
                            <img src="img/product-img/big-deal2.png" alt="">
                            <a href="shop-left-sidebar.php" class="btn btn-primary wd-shop-btn pos-2">Shop Now</a>
                            <div class="count-down">
                                <div data-countdown="2018/12/11"></div>
                            </div>
                        </div>
                        
                        <div class="sin-big-offer n3">
                            <img src="img/product-img/big-deal3.png" alt="">
                            <a href="shop-left-sidebar.php" class="btn btn-primary wd-shop-btn pos-3">Shop Now</a>
                        </div>
                    </div>
                    <!--Magazine Big offer end-->
                        ...
                        <div class="wd-service">
                            <div class="row">
                                <div class="col-md-12 col-lg-4 col-xl-4 wow fadeIn animated" data-wow-delay="0.2s">
                                    <ul class="list-unstyled">
                                        <li class="media">
                                            <img class="d-flex mr-3" src="img/compare-icon.png" alt="compare-icon">
                                            <div class="media-body">
                                ...
                                <div class="col-md-12 col-lg-4 col-xl-4 wow fadeIn animated" data-wow-delay="0.4s">
                                    <ul class="list-unstyled">
                                        <li class="media">
                                            <img class="d-flex mr-3" src="img/review-icon.png" alt="compare-icon">
                                            <div class="media-body">
                                ...
                                <div class="col-md-12 col-lg-4 col-xl-4 wow fadeIn animated" data-wow-delay="0.6s">
                                    <ul class="list-unstyled">
                                        <li class="media">
                                            <img class="d-flex mr-3" src="img/store-icon.png" alt="compare-icon">
                                            <div class="media-body">
    		...
    		<div class="choose-category-area-box">
	    		<div class="row">
					<div class="col-md-12 text-center">
						<h2 class="choose-category-main-title">- Categories -</h2>
					</div>
	    			<div class="col-sm-6 col-md-4 col-lg-3 choose-category-box wow fadeIn animated" data-wow-delay="300ms">
						<div class="d-flex justify-content-start align-items-center">
		    				<div class="category-info">
								<h6 class="choose-category-title">Mobile Phones</h6>
	    						<div class="choose-category-content">
									<p>Compare and buy best Branded
									mobile phones</p>
	    						</div>
	    						<a href="catogary.php" class="badge badge-light choose-category-link">Check best price list</a>
		    				</div>
	    			...
	    			<div class="col-sm-6 col-md-4 col-lg-3 choose-category-box wow fadeIn animated" data-wow-delay="600ms">
						<div class="d-flex justify-content-start align-items-center">
		    				<div class="category-info">
								<h6 class="choose-category-title">Computers</h6>
	    						<div class="choose-category-content">
									<p>Compare and buy best Branded
									computers</p>
	    						</div>
		    				...
		    				<div class="category-img">
		    					<a href="shop-left-sidebar.php"><img class="img-fluid" src="img/categories/cat-laptop.png" alt=""></a>
		    				</div>
						</div>
	    			...
	    			<div class="col-sm-6 col-md-4 col-lg-3 choose-category-box wow fadeIn animated" data-wow-delay="900ms">
						<div class="d-flex justify-content-start align-items-center">
		    				<div class="category-info">
								<h6 class="choose-category-title">House-Hold</h6>
	    						<div class="choose-category-content">
									<p>All you need for your house at one place</p>
	    						</div>
	    						<a href="#" class="badge badge-light choose-category-link">Check best price list</a>
		    				</div>
		    				<div class="category-img">
		    					<a href="shop-left-sidebar.php"><img class="img-fluid" src="img/categories/cat-household.png" alt=""></a>
		    				</div>
						</div>
	    			...
	    			<div class="col-sm-6 col-md-4 col-lg-3 choose-category-box wow fadeIn animated" data-wow-delay="1200ms">
						<div class="d-flex justify-content-start align-items-center">
		    				<div class="category-info">
								<h6 class="choose-category-title">Beauty</h6>
	    						<div class="choose-category-content">
									<p>Trusted beauty products, compare with reviews</p>
	    						</div>
	    						<a href="#" class="badge badge-light choose-category-link">Check best price list</a>
		    				</div>
		    				<div class="category-img">
		    					<a href="shop-left-sidebar.php"><img class="img-fluid" src="img/categories/cat-beauty.png" alt=""></a>
		    				</div>
						</div>
	    			...
	    			<div class="col-sm-6 col-md-4 col-lg-3 choose-category-box wow fadeIn animated" data-wow-delay="0ms">
						<div class="d-flex justify-content-start align-items-center">
		    				<div class="category-info">
								<h6 class="choose-category-title">Health</h6>
	    						<div class="choose-category-content">
									<p>Health is important! check out top rated health products.</p>
	    						</div>
	    						<a href="#" class="badge badge-light choose-category-link">Check best price list</a>
		    				</div>
		    				<div class="category-img">
		    					<a href="shop-left-sidebar.php"><img class="img-fluid" src="img/categories/cat-healthnbeauty.png" alt=""></a>
		    				</div>
						</div>
	    			...
	    			<div class="col-sm-6 col-md-4 col-lg-3 choose-category-box wow fadeIn animated" data-wow-delay="0ms">
						<div class="d-flex justify-content-start align-items-center">
		    				<div class="category-info">
								<h6 class="choose-category-title">Vehicles</h6>
	    						<div class="choose-category-content">
									<p>Top rated highest quality vehicles at once place</p>
	    						</div>
	    						<a href="#" class="badge badge-light choose-category-link">Check best price list</a>
		    				</div>
		    				<div class="category-img">
		    					<a href="shop-left-sidebar.php"><img class="img-fluid" src="img/categories/cat-automative.png" alt=""></a>
		    				</div>
						</div>
						<span class="wd-border-bottom" style="background: #84ffff"></span>
	    			</div>
	    			<div class="col-sm-6 col-md-4 col-lg-3 choose-category-box wow fadeIn animated" data-wow-delay="0ms">
						<div class="d-flex justify-content-start align-items-center">
		    				<div class="category-info">
								<h6 class="choose-category-title">Vehicle Parts</h6>
	    						<div class="choose-category-content">
									<p>Find out all top quaity vehicle parts. </p>
	    						</div>
	    						<a href="#" class="badge badge-light choose-category-link">Check best price list</a>
		    				</div>
		    				<div class="category-img">
		    					<a href="shop-left-sidebar.php"><img class="img-fluid" src="img/categories/cat-auto2.png" alt=""></a>
		    				</div>
						</div>
	    			...
	    			<div class="col-sm-6 col-md-4 col-lg-3 choose-category-box wow fadeIn animated" data-wow-delay="0ms">
						<div class="d-flex justify-content-start align-items-center">
		    				<div class="category-info">
								<h6 class="choose-category-title">Food</h6>
	    						<div class="choose-category-content">
									<p>Top rated food stores and dishes.</p>
	    						</div>
	    						<a href="#" class="badge badge-light choose-category-link">Check best price list</a>
		    				</div>
		    				<div class="category-img">
		    					<a href="shop-left-sidebar.php"><img class="img-fluid" src="img/categories/cat-food.png" alt=""></a>
		    				</div>
						</div>
	    			...
	    			<div class="col-sm-6 col-md-4 col-lg-3 choose-category-box wow fadeIn animated" data-wow-delay="0ms">
						<div class="d-flex justify-content-start align-items-center">
		    				<div class="category-info">
								<h6 class="choose-category-title">Fashion</h6>
	    						<div class="choose-category-content">
									<p>Top rated, uni-sex fashion items with highest ratings</p>
	    						</div>
	    						<a href="#" class="badge badge-light choose-category-link">Check best price list</a>
		    				</div>
		    				<div class="category-img">
		    					<a href="shop-left-sidebar.php"><img class="img-fluid" src="img/categories/cat-fashion.png" alt=""></a>
		    				</div>
						</div>
						<span class="wd-border-bottom" style="background: #ff8a80"></span>
	    			</div>
	    			<div class="col-sm-6 col-md-4 col-lg-3 choose-category-box wow fadeIn animated" data-wow-delay="0ms">
						<div class="d-flex justify-content-start align-items-center">
		    				<div class="category-info">
								<h6 class="choose-category-title">Hotels</h6>
	    						<div class="choose-category-content">
									<p>Checkout top places to your next stay, depending on the ratings</p>
	    						</div>
	    						<a href="#" class="badge badge-light choose-category-link">Check best price list</a>
		    				</div>
		    				<div class="category-img">
		    					<a href="shop-left-sidebar.php"><img class="img-fluid" src="img/categories/cat-hotel.png" alt=""></a>
		    				</div>
						</div>
	    			...
	    			<div class="col-sm-6 col-md-4 col-lg-3 choose-category-box wow fadeIn animated" data-wow-delay="0ms">
						<div class="d-flex justify-content-start align-items-center">
		    				<div class="category-info">
								<h6 class="choose-category-title">Stationaries</h6>
	    						<div class="choose-category-content">
									<p>Compare and buy best Branded
									stationaries </p>
	    						</div>
		    				...
		    				<div class="category-img">
		    					<a href="shop-left-sidebar.php"><img class="img-fluid" src="img/categories/cat-stationaries.png" alt=""></a>
		    				</div>
						</div>
						<span class="wd-border-bottom" style="background: #84ffff"></span>
	    			</div>
	    			<div class="col-sm-6 col-md-4 col-lg-3 choose-category-box wow fadeIn animated" data-wow-delay="0ms">
						<div class="d-flex justify-content-start align-items-center">
		    				<div class="category-info">
								<h6 class="choose-category-title">Personal Care</h6>
	    						<div class="choose-category-content">
									<p>Compare and buy best Branded
									items</p>
	    						</div>
		    				...
		    				<div class="category-img">
		    					<a href="shop-left-sidebar.php"><img class="img-fluid" src="img/categories/cat-personal.png" alt=""></a>
		    				</div>
						</div>
						<span class="wd-border-bottom" style="background: #ff9e80"></span>
	    			</div>
	    			<div class="col-sm-6 col-md-4 col-lg-3 choose-category-box wow fadeIn animated" data-wow-delay="0ms">
						<div class="d-flex justify-content-start align-items-center">
		    				<div class="category-info">
								<h6 class="choose-category-title">Professional Services</h6>
	    						<div class="choose-category-content">
									<p>Compare the services based on ratings</p>
	    						</div>
	    						<a href="#" class="badge badge-light choose-category-link">Check best price list</a>
		    				</div>
		    				<div class="category-img">
		    					<a href="shop-left-sidebar.php"><img class="img-fluid" src="img/categories/cat-services.png" alt=""></a>
		    				</div>
						</div>
						<span class="wd-border-bottom" style="background: #ea80fc"></span>
	    			</div>
	    			<div class="col-sm-6 col-md-4 col-lg-3 choose-category-box wow fadeIn animated" data-wow-delay="0ms">
						<div class="d-flex justify-content-start align-items-center">
		    				<div class="category-info">
								<h6 class="choose-category-title">Softwares & Apps</h6>
	    						<div class="choose-category-content">
									<p>In-depth reviews on apps and all softwares</p>
	    						</div>
	    						<a href="#" class="badge badge-light choose-category-link">Check best price list</a>
		    				</div>
		    				<div class="category-img">
		    					<a href="shop-left-sidebar.php"><img class="img-fluid" src="img/categories/cat-software.png" alt=""></a>
		    				</div>
						</div>
	    			...
	    			<div class="col-sm-6 col-md-4 col-lg-3 choose-category-box wow fadeIn animated" data-wow-delay="0ms">
						<div class="d-flex justify-content-start align-items-center">
		    				...
		    				<div class="category-img">
		    					<a href="shop-left-sidebar.php"><img class="img-fluid" src="img/categories/cat-grocery.png" alt=""></a>
		    				</div>
						</div>
	    			...
	    			<div class="col-sm-6 col-md-4 col-lg-3 choose-category-box wow fadeIn animated" data-wow-delay="0ms">
						<div class="d-flex justify-content-start align-items-center">
		    				<div class="category-info">
								<h6 class="choose-category-title">Video & Audio</h6>
	    						<div class="choose-category-content">
									<p>Compare and buy best Branded
									Cameras Mic and light</p>
	    						</div>
	    						<a href="#" class="badge badge-light choose-category-link">Check best price list</a>
		    				</div>
		    				<div class="category-img">
		    					<a href="shop-left-sidebar.php"><img class="img-fluid" src="img/categories/cat-video.png" alt=""></a>
		    				</div>
						</div>
						<span class="wd-border-bottom" style="background: #a788ff"></span>
	    			</div>
					...
					<div class="row">
						...
						<div class="col-md-12 col-lg-8">
							<ul class="nav nav-tabs wd-amazon-product-tabs " id="myTab-recent" role="tablist">
								<li class="nav-item">
									<a class="nav-link active" id="home-tab" data-toggle="tab" href="#home" role="tab" aria-controls="home" aria-expanded="true">Electronic</a>
								</li>
								<li class="nav-item">
									<a class="nav-link" id="ebay-tab" data-toggle="tab" href="#ebay" role="tab" aria-controls="ebay">Health and Beauty</a>
								</li>
								<li class="nav-item">
									<a class="nav-link" id="Elipkart-tab" data-toggle="tab" href="#Elipkart" role="tab" aria-controls="Elipkart">Household</a>
								</li>
								<li class="nav-item">
									<a class="nav-link" id="aliexpress-tab" data-toggle="tab" href="#aliexpress" role="tab" aria-controls="aliexpress">Automotive</a>
								</li>
								<li class="nav-item">
									<a class="nav-link" id="alibaba-tab" data-toggle="tab" href="#alibaba" role="tab" aria-controls="alibaba">Grocery</a>
								</li>
							</ul>
						</div>
					</div>
    		...
    		<div class="row">
    			<div class="col-md-12">
					<h2 class="review-title">
						Check <span>REVIEW</span> With <span>BLURB</span> Theme to make <br>
					...
					<div class="test-slider-up owl-carousel owl-theme row wow fadeInRight animated" data-wow-delay="300ms">
					    <div class="item">
							<ul class="list-unstyled review-list">
							  <li class="media">
								<div class="media">
									<img class="d-flex mr-3" src="img/review/th-review-author-img-1.png" alt="Generic placeholder image">
									<div class="media-body">
										<div class="rating">
											<a href="#"><i class="fa fa-star active-color" aria-hidden="true"></i></a>
											<a href="#"><i class="fa fa-star active-color" aria-hidden="true"></i></a>
							  ...
							  <li class="media">
								<div class="media">
									<img class="d-flex mr-3" src="img/review/th-review-author-img-2.png" alt="Generic placeholder image">
									<div class="media-body">
										<div class="rating">
											<a href="#"><i class="fa fa-star active-color" aria-hidden="true"></i></a>
											<a href="#"><i class="fa fa-star active-color" aria-hidden="true"></i></a>
							  ...
							  <li class="media">
								<div class="media">
									<img class="d-flex mr-3" src="img/review/th-review-author-img-3.png" alt="Generic placeholder image">
									<div class="media-body">
										<div class="rating">
											<a href="#"><i class="fa fa-star active-color" aria-hidden="true"></i></a>
											<a href="#"><i class="fa fa-star active-color" aria-hidden="true"></i></a>
							  ...
							  <li class="media">
								<div class="media">
									<img class="d-flex mr-3" src="img/review/th-review-author-img-4.png" alt="Generic placeholder image">
									<div class="media-body">
										<div class="rating">
											<a href="#"><i class="fa fa-star active-color" aria-hidden="true"></i></a>
											<a href="#"><i class="fa fa-star active-color" aria-hidden="true"></i></a>
    				...
    				<div class="row">
	    				<div class="col-12 col-sm-6 col-md-6 col-xl-3 p0">
	    					<div class="bast-rated-box">
								<div class="media">
									<a href="product-details.php"><img class="d-flex mr-3" src="img/best-rated/best-reted-img.jpg" alt="Generic placeholder image"></a>
									<div class="media-body">
	    				...
	    				<div class="col-12 col-sm-6 col-md-6 col-xl-3 p0">
	    					<div class="bast-rated-box">
								<div class="media">
									<a href="product-details.php"><img class="d-flex mr-3" src="img/best-rated/best-reted-img-2.jpg" alt="Generic placeholder image"></a>
									<div class="media-body">
										<strong class="price">$50.00 - $60.00</strong>
										<p class="rated-content">Echo Dot ( 2nd Generation )</p>
										<div class="rating">
	    				...
	    				<div class="col-12 col-sm-6 col-md-6 col-xl-3 p0">
	    					<div class="bast-rated-box">
								<div class="media">
									<a href="product-details.php"><img class="d-flex mr-3" src="img/best-rated/best-reted-img-3.jpg" alt="Generic placeholder image"></a>
									<div class="media-body">
										<strong class="price">$50.00 - $60.00</strong>
										<p class="rated-content">Echo Dot ( 2nd Generation )</p>
										<div class="rating">
	    				...
	    				<div class="col-12 col-sm-6 col-md-6 col-xl-3 p0">
	    					<div class="bast-rated-box">
								<div class="media">
									<a href="product-details.php"><img class="d-flex mr-3" src="img/best-rated/best-reted-img-4.jpg" alt="Generic placeholder image"></a>
									<div class="media-body">
										<strong class="price">$50.00 - $60.00</strong>
										<p class="rated-content">Echo Dot ( 2nd Generation )</p>
										<div class="rating">
	    				...
	    				<div class="col-12 col-sm-6 col-md-6 col-xl-3 p0">
	    					<div class="bast-rated-box">
								<div class="media">
									<a href="product-details.php"><img class="d-flex mr-3" src="img/best-rated/best-reted-img-5.jpg" alt="Generic placeholder image"></a>
									<div class="media-body">
										<strong class="price">$50.00 - $60.00</strong>
										<p class="rated-content">Echo Dot ( 2nd Generation )</p>
										<div class="rating">
	    				...
	    				<div class="col-12 col-sm-6 col-md-6 col-xl-3 p0">
	    					<div class="bast-rated-box">
								<div class="media">
									<a href="product-details.php"><img class="d-flex mr-3" src="img/best-rated/best-reted-img-6.jpg" alt="Generic placeholder image"></a>
									<div class="media-body">
										<strong class="price">$50.00 - $60.00</strong>
										<p class="rated-content">Echo Dot ( 2nd Generation )</p>
										<div class="rating">
	    				...
	    				<div class="col-12 col-sm-6 col-md-6 col-xl-3 p0">
	    					<div class="bast-rated-box">
								<div class="media">
									<a href="product-details.php"><img class="d-flex mr-3" src="img/best-rated/best-reted-img-7.jpg" alt="Generic placeholder image"></a>
									<div class="media-body">
										<strong class="price">$50.00 - $60.00</strong>
										<p class="rated-content">Echo Dot ( 2nd Generation )</p>
										<div class="rating">
	    				...
	    				<div class="col-12 col-sm-6 col-md-6 col-xl-3 p0">
	    					<div class="bast-rated-box">
								<div class="media">
									<a href="product-details.php"><img class="d-flex mr-3" src="img/best-rated/best-reted-img-8.jpg" alt="Generic placeholder image"></a>
									<div class="media-body">
										<strong class="price">$50.00 - $60.00</strong>
										<p class="rated-content">Echo Dot ( 2nd Generation )</p>
										<div class="rating">
	    				...
	    				<div class="col-12 col-sm-6 col-md-6 col-xl-3 p0">
	    					<div class="bast-rated-box">
								<div class="media">
									<a href="product-details.php"><img class="d-flex mr-3" src="img/best-rated/best-reted-img-9.jpg" alt="Generic placeholder image"></a>
									<div class="media-body">
										<strong class="price">$50.00 - $60.00</strong>
										<p class="rated-content">Echo Dot ( 2nd Generation )</p>
										<div class="rating">
	    				...
	    				<div class="col-12 col-sm-6 col-md-6 col-xl-3 p0">
	    					<div class="bast-rated-box">
								<div class="media">
									<a href="product-details.php"><img class="d-flex mr-3" src="img/best-rated/best-reted-img-10.jpg" alt="Generic placeholder image"></a>
									<div class="media-body">
										<strong class="price">$50.00 - $60.00</strong>
										<p class="rated-content">Echo Dot ( 2nd Generation )</p>
										<div class="rating">
	    				...
	    				<div class="col-12 col-sm-6 col-md-6 col-xl-3 p0">
	    					<div class="bast-rated-box">
								<div class="media">
									<a href="product-details.php"><img class="d-flex mr-3" src="img/best-rated/best-reted-img-11.jpg" alt="Generic placeholder image"></a>
									<div class="media-body">
										<strong class="price">$50.00 - $60.00</strong>
										<p class="rated-content">Echo Dot ( 2nd Generation )</p>
										<div class="rating">
	    				...
	    				<div class="col-12 col-sm-6 col-md-6 col-xl-3 p0">
	    					<div class="bast-rated-box">
								<div class="media">
									<a href="product-details.php"><img class="d-flex mr-3" src="img/best-rated/best-reted-img-12.jpg" alt="Generic placeholder image"></a>
									<div class="media-body">
										<strong class="price">$50.00 - $60.00</strong>
										<p class="rated-content">Echo Dot ( 2nd Generation )</p>
										<div class="rating">
    		...
    		<div class="row">
    				...
    				<div class="weekly-news-box">
						<figure class="figure">
							<div class="weekly-news-img text-left">
								<img src="img/weekly-news/weekly-news-img-1.jpg" class="figure-img img-fluid rounded" alt="weekly-news-img">
								<div class="weekly-news-title">
									<a href="single-blog-with.php"><h4>Most wonderfull affiliate market theme and template BLURB</h4></a>
								</div>
							</div>
							<figcaption class="figure-caption">
								<div class="blog-meta container">
									<div class="row">
										<div class="col blog-meta-box">
											<a href="single-blog-with.php"><i class="fa fa-thumbs-up" aria-hidden="true"></i> Likes  115</a>
										</div>
										<div class="col blog-meta-box">
											<a href="single-blog-with.php"><i class="fa fa-commenting" aria-hidden="true"></i> Comments  59</a>
										</div>
										<div class="col blog-meta-box">
											<a href="single-blog-with.php"><i class="fa fa-share-alt-square" aria-hidden="true"></i> Share  20</a>
										</div>
									</div>
								</div>
								...
								<a href="single-blog-with.php" class="badge badge-light wd-news-more-btn">Read More <i class="fa fa-arrow-right" aria-hidden="true"></i></a>
							</figcaption>
						</figure>
    			...
    			<div class=" col-sm-6 col-md-6 col-xl-3 wow fadeInRight animated" data-wow-delay="600ms">
    				<div class="weekly-news-box">
						<figure class="figure">
							<div class="weekly-news-img text-left">
								<img src="img/weekly-news/weekly-news-img-2.jpg" class="figure-img img-fluid rounded" alt="weekly-news-img">
								<div class="weekly-news-title">
									<a href="single-blog-with.php"><h4>Power is your hand if you get money making theme </h4></a>
								</div>
							</div>
							<figcaption class="figure-caption">
								<div class="blog-meta container">
    			...
    			<div class=" col-sm-6 col-md-6 col-xl-3 wow fadeInRight animated" data-wow-delay="900ms">
    				<div class="weekly-news-box">
						<figure class="figure">
							<div class="weekly-news-img text-left">
								<img src="img/weekly-news/weekly-news-img-3.jpg" class="figure-img img-fluid rounded" alt="weekly-news-img">
								<div class="weekly-news-title">
									<a href="single-blog-with.php"><h4>No need to develop online store if you have idea like BLURB</h4></a>
								</div>
							</div>
							<figcaption class="figure-caption">
								<div class="blog-meta container">
    			...
    			<div class=" col-sm-6 col-md-6 col-xl-3 wow fadeInRight animated" data-wow-delay="1200ms">
    				<div class="weekly-news-box">
						<figure class="figure">
							<div class="weekly-news-img text-left">
								<img src="img/weekly-news/weekly-news-img-4.jpg" class="figure-img img-fluid rounded" alt="weekly-news-img">
								<div class="weekly-news-title">
									<a href="single-blog-with.php"><h4>Money making is easy to get our themes with affiliate market idea</h4></a>
								</div>
							</div>
							<figcaption class="figure-caption">
								<div class="blog-meta container">
    ...
    <section id="wd-counter" class=" wow bounceIn animated" data-wow-delay="300ms">
    	<div class="container-fluid custom-width text-center">
    		<div class="row">
    			<div class="col-6 col-sm-6 col-md-4 col-lg-2 wd-counter-box">
    				<img src="img/counter-img/counter-img-1.png" alt="counter-img">
    				<p><span class="counter">3000</span>+ Products</p>
    			</div>
    			<div class="col-6 col-sm-6 col-md-4 col-lg-2 wd-counter-box">
    				<img src="img/counter-img/counter-img-2.png" alt="counter-img">
    				<p><span class="counter">2600</span>+ Products</p>
    			</div>
    			<div class="col-6 col-sm-6 col-md-4 col-lg-2 wd-counter-box">
    				<img src="img/counter-img/counter-img-3.png" alt="counter-img">
    				<p><span class="counter">1465</span>+ Products</p>
    			</div>
    			<div class="col-6 col-sm-6 col-md-4 col-lg-2 wd-counter-box">
    				<img src="img/counter-img/counter-img-4.png" alt="counter-img">
    				<p><span class="counter">1200</span>+ Products</p>
    			</div>
    			<div class="col-6 col-sm-6 col-md-4 col-lg-2 wd-counter-box">
    				<img src="img/counter-img/counter-img-5.png" alt="counter-img">
    				<p><span class="counter">2400</span>+ Products</p>
    			</div>
    			<div class="col-6 col-sm-6 col-md-4 col-lg-2 wd-counter-box">
    				<img src="img/counter-img/counter-img-6.png" alt="counter-img">
    				<p><span class="counter">1600</span>+ Products</p>
    			</div>
    		</div>
    	</div>
    </section>
    		...
    		<div class="row">
    			<div class="col-md-12 col-lg-2">
    				...
    				<div class="footer-about">
    					<a href="index.php" class="footer-about-logo">
    						<img src="img/logo.png" alt="Logo">
    					</a>
    			...
    			<div class="col-6 col-md-3 col-lg-2 footer-nav">
    				...
    				<ul>
    					<li><a href="product-details-scroll.php">Getting Started</a></li>
    					<li><a href="contact-us.php">Contact Us</a></li>
    					<li><a href="product-details-scroll.php">FAQ's</a></li>
    					<li><a href="product-details-scroll.php">Press</a></li>
    					<li><a href="product-details-scroll.php">Product Feed</a></li>
    					<li><a href="product-details-scroll.php">Best Rated Product</a></li>
    					<li><a href="product-details-scroll.php">Feature product</a></li>
    				</ul>
    			</div>
    			<div class="col-6 col-md-3 col-lg-2 footer-nav">
    				<!-- ===========================
	    	...
	    	<div class="row">
	    		<div class="col-md-6">
	    			<div class="copyright-text">
	    				<p class="text-uppercase">COPYRIGHT &copy; 2018</p><a class="created-by" href="http://themeim.com/">ThemeIM</a>
	    			</div>
	    		</div>
	    		<div class="col-md-6">
	    			<div class="brand-logo d-flex justify-content-start">
		    			<a href="#">
		    				<img src="img/social-media-img/brand-logo-1.jpg" class="img-fluid" alt="Brand Logo">
		    			</a>
		    			<a href="#">
		    				<img src="img/social-media-img/brand-logo-2.jpg" class="img-fluid" alt="Brand Logo">
		    			</a>
		    			<a href="#">
		    				<img src="img/social-media-img/brand-logo-3.jpg" class="img-fluid" alt="Brand Logo">
		    			</a>
		    			<a href="#">
		    				<img src="img/social-media-img/brand-logo-4.jpg" class="img-fluid" alt="Brand Logo">
		    			</a>
		    			<a href="#">
		    				<img src="img/social-media-img/brand-logo-5.jpg" class="img-fluid" alt="Brand Logo">
		    			</a>
	    			</div>
	    		</div>
	    	</div>
