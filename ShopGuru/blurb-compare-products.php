...
<html class="no-js" lang="">
  ...
  <body class="">
			...
			<div class="row">
				<div class="col-md-12">
					<div class="text-center">
						<h1 class="wishlist-slider-title">Shortcode for Product Compare area</h1>
	                </div>
				</div>
			</div>
		</div>
    	...
    	<div class="container">
            <div class="row compare-folding-section">
                <div class="col-12 text-center">
                    <h2 class="compare-folding-title">Compare Product Area One</h2>
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td class="compare-details-section">
                                    <img src="img/compare/compare-img-1.jpg" class="figure-img img-fluid" alt="compare">
                                            ...
                                            <div class="compare-price text-center">
												...
												<div class="compare-details-price">
													<a href="https://www.amazon.com/" target="_blank" class="btn btn-primary btn-sm compare-details-btn">
														...
														<img src="img/compare/btn-img-1.png" class="figure-img img-fluid" alt="compare">
														<p class="pull-right">$299</p>
													</a>
													<img src="img/compare/best-price.png" class="figure-img img-fluid" alt="compare">
												</div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <td class="compare-details-section">
                                    <img src="img/compare/compare-img-2.jpg" class="figure-img img-fluid" alt="compare">
                                    <div class="product-detail-ph">
                                            ...
                                            <div class="compare-price text-center">
												...
												<div class="compare-details-price">
													<a href="https://www.ebay.com/" target="_blank" class="btn btn-primary btn-sm compare-details-btn">
														<p class="pull-left">Buy now</p>
														<img src="img/compare/btn-img-2.png" class="figure-img img-fluid" alt="compare">
														<p class="pull-right">$299</p>
													</a>
												</div>
                                            </div>
                                ...
                                <td class="compare-details-section">
                                    <img src="img/compare/compare-img-3.jpg" class="figure-img img-fluid" alt="compare">
                                    <div class="product-detail-ph">
										...
										<div class="compare-details-price">
											<a href="https://www.Elipkart.com/" target="_blank" class="btn btn-primary btn-sm compare-details-btn">
												<p class="pull-left">Buy now</p>
												<img src="img/compare/btn-img-3.png" class="figure-img img-fluid" alt="compare">
												<p class="pull-right">$299</p>
											</a>
										</div>
                                            </div>
                                ...
                                <td class="compare-details-section">
                                    <img src="img/compare/compare-img-4.jpg" class="figure-img img-fluid" alt="compare">
                                    <div class="product-detail-ph">
										...
										<div class="compare-details-price">
											<a href="https://www.aliexpress.com/" target="_blank" class="btn btn-primary btn-sm compare-details-btn">
												<p class="pull-left">Buy now</p>
												<img src="img/compare/btn-img-4.png" class="figure-img img-fluid" alt="compare">
												<p class="pull-right">$299</p>
											</a>
										</div>
                                            </div>
                                ...
                                <td class="compare-details-section">
                                    <img src="img/compare/compare-img-5.jpg" class="figure-img img-fluid" alt="compare">
                                    <div class="product-detail-ph">
                                            ...
                                            <div class="compare-price text-center">
												...
												<div class="compare-details-price">
													<a href="https://www.snapdeal.com/" target="_blank" class="btn btn-primary btn-sm compare-details-btn">
														<p class="pull-left">Buy now</p>
														<img src="img/compare/btn-img-5.png" class="figure-img img-fluid" alt="compare">
														<p class="pull-right">$299</p>
													</a>
												</div>
                                            </div>
    ...
    <section class="compare-2 ">
        <div class="container">
            <div class="row compare-folding-section">
                <h2 class="compare-folding-title">Compare Product area two</h2>
            </div>
            <div class="row compare-products">
                <div class="col-12 p0">
                    <div class="product-info container">
                        <div class="row">
                            <div class="col-12 col-md-12 col-lg-2 col-xl-2 single-compare-product-img text-center">
                                <img src="img/compare/single-product-img-1.jpg" class="figure-img img-fluid" alt="compare">
                                <p>Sanon cybershot x13</p>
                            </div>
                                ...
                                <div class="row">
                                    <div class="col-md-12 p0">
                                        <div class="brand-logos">
                                            <ul>
                                                <li>
                                                    <img src="img/compare/single-product-market-1.jpg" class="figure-img img-fluid" alt="compare">
                                                ...
                                                <li>
                                                    <img src="img/compare/single-product-market-2.jpg" class="figure-img img-fluid" alt="compare">
                                                    <ul class="review-content">
                                                        <li>$ 140 - $ 233</li>
                                                        <li>
                                                            <div class="rating">
                                                ...
                                                <li>
                                                    <img src="img/compare/single-product-market-3.jpg" class="figure-img img-fluid" alt="compare">
                                                    <ul class="review-content">
                                                        <li>$ 80 - $ 100</li>
                                                        <li>
                                                            <div class="rating">
                                                ...
                                                <li>
                                                    <img src="img/compare/single-product-market-4.jpg" class="figure-img img-fluid" alt="compare">
                                                    <ul class="review-content">
                                                        <li>$ 90 - $ 120</li>
                                                        <li>
                                                            <div class="rating">
                                                ...
                                                <li>
                                                    <img src="img/compare/single-product-market-5.jpg" class="figure-img img-fluid" alt="compare">
                                                    <ul class="review-content">
                                                        <li>$ 70 - $ 200</li>
                                                        <li>
                                                            <div class="rating">
                                    ...
                                    <div class="col-md-12 p0">
                                        <div class="product-description">
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <ul>
                                                        <li><i class="fa fa-dot-circle-o" aria-hidden="true"></i> Automatically detects the brightness of the surrounding and</li>
                                                        <li><i class="fa fa-dot-circle-o" aria-hidden="true"></i> adjusts the amount of flash and shutter spee</li>
                                                        <li><i class="fa fa-dot-circle-o" aria-hidden="true"></i> quality Double photographing kids, pets and other fast moving</li>
                                                    </ul>
                                                </div>
                                                <div class="col-md-6">
                                                    <ul>
                    ...
                    <table class="col-md-12 p0 table table-responsive compare-products-single-table display-none-md">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><strong class="active-color">5 <i class="fa fa-star-o" aria-hidden="true"></i></strong></td>
                                    <td><strong class="active-color">4 <i class="fa fa-star-o" aria-hidden="true"></i></strong></td>
                                    <td><strong class="active-color">3 <i class="fa fa-star-o" aria-hidden="true"></i></strong></td>
                                    <td><strong class="active-color">2 <i class="fa fa-star-o" aria-hidden="true"></i></strong></td>
                                    <td><strong class="active-color">1 <i class="fa fa-star-o" aria-hidden="true"></i></strong></td>
                                </tr>
                                <tr>
                                    <td>Warranty</td>
                                    <td>2 years</td>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <a href="https://www.amazon.com/" target="_blank" class="btn btn-primary select-market-btn">
                                            Buy now <i class="fa fa-angle-right" aria-hidden="true"></i>
                                        </a>
                                    </td>
                                    <td class="text-center">
                                        <a href="https://www.aliexpress.com/" target="_blank" class="btn btn-primary select-market-btn">
                                            Buy now <i class="fa fa-angle-right" aria-hidden="true"></i>
                                        </a>
                                    </td>
                                    <td class="text-center">
                                        <a href="https://www.ebay.com/" target="_blank" class="btn btn-primary select-market-btn">
                                            Buy now <i class="fa fa-angle-right" aria-hidden="true"></i>
                                        </a>
                                    </td>
                                    <td class="text-center">
                                        <a href="https://www.snapdeal.com/" target="_blank" class="btn btn-primary select-market-btn">
                                            Buy now <i class="fa fa-angle-right" aria-hidden="true"></i>
                                        </a>
                                    </td>
                                    <td class="text-center">
                                        <a href="https://www.Elipkart.com/" target="_blank" class="btn btn-primary select-market-btn">
                                            Buy now <i class="fa fa-angle-right" aria-hidden="true"></i>
                                        </a>
                                    </td>
                                </tr>
   ...
   <!-- =========================
    		...
    		<div class="choose-category-area-box">
	    		<div class="row">
					<div class="col-md-12 text-center">
						<h2 class="choose-category-main-title">Recent Product Comparison style three</h2>
					</div>
	...
	<section id="recent-product" class="recent-pro-2">
    	<div class="container-fluid custom-width">
    		<div class="row">
    			<div class="col-md-12 text-center">
    				<h2 class="recent-product-title">Compare Product area four</h2>
    			</div>
