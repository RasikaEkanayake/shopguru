												...
												<form>
													<div class="row">
														<div class="form-group col-md-6">
															...
															<input type="text" class="form-control" id="exampleInputEmailwdfn" placeholder="Email">
														</div>
														<div class="form-group col-md-6">
															<label for="exampleInputPasswordwdfe">Email *</label>
															<input type="email" class="form-control" id="exampleInputPasswordwdfe" placeholder="Password">
														</div>
														<div class="form-group col-md-12">
															<label for="exampleInputPasswordwdfp">Your Comments *</label>
															<textarea class="form-control comment-textarea" id="exampleInputPasswordwdfp"></textarea>
														</div>
												  	</div>
