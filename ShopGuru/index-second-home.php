    ...
    <section id="main-slider-section">
    	<div id="main-slider" class="slider-bg2  owl-carousel owl-theme product-review slider-cat">
           ...
           <div class="item d-flex  slider-bg align-items-center">
				<div class="container-fluid">
					<div class="row justify-content-end">
						<div class="slider-text col-sm-6 col-xl-4  order-2 order-sm-1 col-md-6">
							<h6 class="sub-title">Choose your favourite market</h6>
							<h1 class="slider-title"><strong class="highlights-text">Compare</strong> Best Prices</h1>
							<p class="slider-content">Grabe it hurry.</p>
							<a href="shop-left-sidebar.php" class="btn btn-primary wd-shop-btn slider-btn">
						...
						<div class="col-sm-6 col-md-6 col-xl-6  order-1 order-sm-2  slider-img fadeInDown animated">
    	...
    	<div class="container-fluid custom-width">
    		<div class="amazon-review-box-area">
	    		<div class="row m0 justify-content-center ">
						...
						<div class="media">
							<div class="row">
								<div class="col-sm-4 col-md-5">
									<img class="img-fluid" src="img/product-img/product-img-9.jpg" alt="Generic placeholder image">
								</div>
								<div class="col-sm-8 col-md-7 p0 d-flex align-items-center">
									<div class="amazon-review-box-content">
										...
										<h6 class="amazon-review-box-title">Mpow Bluetooth Headphones</h6>
										...
										<a href="product-details.php" class="btn btn-primary amazon-details">Details <i class="fa fa-arrow-right" aria-hidden="true"></i></a>
									</div>
								</div>
							</div>
						</div>
	    			</div>
	    			<div class="col-12 col-md-6 col-lg-4 p0 amazon-review-box wow fadeIn animated" data-wow-delay="0.4s">
						<div class="media">
							<div class="row">
								<div class="col-sm-4 col-md-5">
									<img class="img-fluid" src="img/product-img/product-img-22.jpg" alt="Generic placeholder image">
								</div>
								<div class="col-sm-8 col-md-7 p0 d-flex align-items-center">
									<div class="amazon-review-box-content">
										<div class="rating">
										...
										<h6 class="amazon-review-box-title">New smartphone for your pocket</h6>
										<p class="amazon-review-content">IMPRESSIVE SOUND QUALITY IS THE ULTIOAL &amp; assive noise isolating, NOT active noise cancellation(ANC).</p>
										<div class="price">
	    			...
	    			<div class="col-12 col-md-6 col-lg-4 p0 amazon-review-box wow fadeIn animated" data-wow-delay="0.6s">
						<div class="media">
							<div class="row">
								<div class="col-sm-4 col-md-5">
									<img class="img-fluid" src="img/product-img/product-img-23.jpg" alt="Generic placeholder image">
								</div>
								<div class="col-sm-8 col-md-7 p0 d-flex align-items-center">
									<div class="amazon-review-box-content">
										<div class="rating">
										...
										<h6 class="amazon-review-box-title">Mega offer for LG TV Monitor</h6>
										<p class="amazon-review-content">IMPRESSIVE SOUND QUALITY IS THE ULTIOAL &amp; assive noise isolating, NOT active noise cancellation(ANC).</p>
										<div class="price">
    			...
    			<div class="col-12 col-md-6 col-lg-6 col-xl-4 wow fadeIn animated" data-wow-delay="300ms">
    				<div class="categories-big-box">
    					<div class="categories-title">
    						Most viewed your product video
    					</div>
					    <!-- =========================
					        Youtube Video Section
					    ============================== -->
						<div data-video="cBNBnpmyGM0" id="video">
						  <img class="figure-img img-fluid" src="img/2.jpg" alt="Youtube Video">
						</div>
    				</div>
    			</div>
	    						...
	    						<div class="col-md-12">
	    							<div class="d-flex justify-content-start align-items-center">
	    								<div class="categories-info">
	    									<h2 class="categories-name">Smart Phone</h2>
	    									<p class="categories-content">Brilliant visual displays Monitors</p>
											<a href="shop-left-sidebar.php" class="btn btn-primary wd-shop-btn">
												Shop now
											</a>
	    								</div>
	    								<div class="categories-img align-items-center">
	    									<img src="img/categories/categories-img-24.jpg" class="img-fluid" alt="categories-img">
	    								</div>
	    							</div>
	    						</div>
	    					</div>
	    				...
	    				<div class="container">
	    					<div class="row">
	    						<div class="col-md-12">
	    							<div class="d-flex justify-content-start align-items-center">
	    								<div class="categories-img align-items-center">
	    									<img src="img/categories/categories-img-2.jpg" class="img-fluid" alt="categories-img">
	    								</div>
	    								<div class="categories-info">
	    									<h2 class="categories-name">Phone 6610</h2>
	    									<p class="categories-content">Brilliant visual displays Monitors</p>
											<a href="shop-left-sidebar.php" class="btn btn-primary wd-shop-btn">
												Shop now
											</a>
    			...
    			<div class="col-12 col-md-12 col-lg-12 col-xl-4 wow fadeIn animated" data-wow-delay="1200ms">
    				<div class="categories-big-box text-center">
    					<div class="featured-img">
    						<img src="img/categories/categories-img-3.jpg" class="img-fluid" alt="featured-img">
    					</div>
    					<div class="featured-info">
    						<h3 class="featured-product-title">
    							Phone Lumia 730 Dual SIM
    						</h3>
							<div class="rating">
								<a href="#"><i class="fa fa-star active-color" aria-hidden="true"></i></a>
								<a href="#"><i class="fa fa-star active-color" aria-hidden="true"></i></a>
    		...
    		<div class="row">
    			<div class="col-12 col-md-12 col-lg-4 wow fadeInLeft animated" data-wow-delay="300ms">
    				...
    				<div class="message-bar-chart">
    					<img src="img/message-bar-chart.png" class="img-fluid" alt="message-bar-chart">
    				</div>
    			</div>
    			<div class="col-md-1"></div>
    			<div class="col-12 col-md-12 col-lg-7 wow fadeInRight animated" data-wow-delay="300ms">
    				<div class="big-message-img">
    					<img src="img/only-image.png" class="img-fluid" alt="">
    				</div>
    			</div>
    		</div>
    	</div>
    ...
    <section id="recent-product" class="recent-pro-2">
    	<div class="container-fluid custom-width">
    		<div class="row">
    			...
    			<div class="col-12 col-sm-6 col-md-4 col-lg-3 col-xl-2 wow fadeIn animated" data-wow-delay="100ms">
    				<div class="recent-product-box">
    					<div class="recent-product-img">
    						<a href="product-details.php"><img src="img/product-img/product-img-12.jpg" class="img-fluid" alt="recent-product img"></a>
    			...
    			<div class="col-12 col-sm-6 col-md-4 col-lg-3 col-xl-2 wow fadeIn animated" data-wow-delay="200ms">
    				<div class="recent-product-box">
    					<div class="recent-product-img">
    						<a href="product-details.php"><img src="img/product-img/product-img-13.jpg" class="img-fluid" alt="recent-product img"></a>
    						<span class="badge badge-secondary wd-badge green-bg text-uppercase">Hot</span>
    						<div class="recent-product-info">
	    						<div class="d-flex justify-content-between">
	    							<div class="recent-price">
	    								$15.45 - $50.00
    			...
    			<div class="col-sm-6 col-12 col-md-4 col-lg-3 col-xl-2 wow fadeIn animated" data-wow-delay="300ms">
    				<div class="recent-product-box">
    					<div class="recent-product-img">
    						<a href="product-details.php"><img src="img/product-img/product-img-15.jpg" class="img-fluid" alt="recent-product img"></a>
    						<span class="badge badge-secondary wd-badge text-uppercase">New</span>
    						<div class="recent-product-info">
	    						<div class="d-flex justify-content-between">
	    							<div class="recent-price">
    			...
    			<div class="col-sm-6 col-12 col-md-4 col-lg-3 col-xl-2 wow fadeIn animated" data-wow-delay="400ms">
    				<div class="recent-product-box">
    					<div class="recent-product-img">
    						<a href="product-details.php"><img src="img/product-img/product-img-16.jpg" class="img-fluid" alt="recent-product img"></a>
    						<span class="badge badge-secondary wd-badge text-uppercase">New</span>
    						<div class="recent-product-info">
	    						<div class="d-flex justify-content-between">
	    							<div class="recent-price">
    			...
    			<div class="col-sm-6 col-12 col-md-4 col-lg-3 col-xl-2 wow fadeIn animated" data-wow-delay="500ms">
    				<div class="recent-product-box">
    					<div class="recent-product-img">
    						<a href="product-details.php"><img src="img/product-img/product-img-14.jpg" class="img-fluid" alt="recent-product img"></a>
    						<span class="badge badge-secondary wd-badge text-uppercase">New</span>
    						<div class="recent-product-info">
	    						<div class="d-flex justify-content-between">
	    							<div class="recent-price">
    			...
    			<div class="col-sm-6 col-12 col-md-4 col-lg-3 col-xl-2 wow fadeIn animated" data-wow-delay="600ms">
    				<div class="recent-product-box">
    					<div class="recent-product-img">
    						<a href="product-details.php"><img src="img/product-img/product-img-17.jpg" class="img-fluid" alt="recent-product img"></a>
    						<span class="badge badge-secondary wd-badge text-uppercase">New</span>
    						<div class="recent-product-info">
	    						<div class="d-flex justify-content-between">
	    							<div class="recent-price">
    			...
    			<div class="col-sm-6 col-12 col-md-4 col-lg-3 col-xl-2 wow fadeIn animated" data-wow-delay="700ms">
    				<div class="recent-product-box">
    					<div class="recent-product-img">
    						<a href="product-details.php"><img src="img/product-img/product-img-15.jpg" class="img-fluid" alt="recent-product img"></a>
    						<span class="badge badge-secondary wd-badge text-uppercase">New</span>
    			...
    			<div class="col-sm-6 col-12 col-md-4 col-lg-3 col-xl-2 wow fadeIn animated" data-wow-delay="900ms">
    				<div class="recent-product-box">
    					<div class="recent-product-img">
    						<a href="product-details.php"><img src="img/product-img/product-img-16.jpg" class="img-fluid" alt="recent-product img"></a>
    						<span class="badge badge-secondary wd-badge text-uppercase">New</span>
    			...
    			<div class="col-sm-6 col-12 col-md-4 col-lg-3 col-xl-2 wow fadeIn animated" data-wow-delay="1000ms">
    				<div class="recent-product-box">
    					<div class="recent-product-img">
    						<a href="product-details.php"><img src="img/product-img/product-img-12.jpg" class="img-fluid" alt="recent-product img"></a>
    						<span class="badge badge-secondary wd-badge text-uppercase">New</span>
    			...
    			<div class="col-sm-6 col-12 col-md-4 col-lg-3 col-xl-2 wow fadeIn animated" data-wow-delay="1200ms">
    				<div class="recent-product-box">
    					<div class="recent-product-img">
    						<a href="product-details.php"><img src="img/product-img/product-img-17.jpg" class="img-fluid" alt="recent-product img"></a>
    						<span class="badge badge-secondary wd-badge text-uppercase">New</span>
    			...
    			<div class="col-sm-6 col-12 col-md-4 col-lg-3 col-xl-2 wow fadeIn animated" data-wow-delay="1400ms">
    				<div class="recent-product-box">
    					<div class="recent-product-img">
    						<a href="product-details.php"><img src="img/product-img/product-img-13.jpg" class="img-fluid" alt="recent-product img"></a>
    						<span class="badge badge-secondary wd-badge text-uppercase">New</span>
			...
			<div class="row">
					...
					<div class="offer-time-box">
						<div class="row">
							<div class="col-sm-5 col-md-6">
								<img src="img/nokia.jpg" alt="offer img" class="offer-img">
							</div>
				...
				<div class="col-12 col-md-12 col-lg-12 col-xl-6 wow fadeInRight animated" data-wow-delay="300ms">
					<div class="offer-time-box">
						<div class="row">
							<div class="col-sm-5 col-md-6">
								<img src="img/iphon.jpg" alt="offer img" class="offer-img">
							</div>
							<div class="col-sm-7 col-md-6 d-flex align-items-center">
								<div class="offer-content">
    		...
    		<div class="row">
    			...
    			<div class="col-12 col-sm-6 col-md-6 col-lg-6 col-xl-3 wow fadeIn animated" data-wow-delay="300ms">
    				<div class="wd-news-box">
						<figure class="figure">
							...
							<img src="img/blog/news-img-1.jpg" class="figure-img img-fluid rounded" alt="news-img">
							<div class="wd-news-info">
								<div class="figure-caption"><a href="single-blog-with.php">ThemeIM provides best affiliate theme and templates like BLURB</a></div>
    			...
    			<div class="col-12 col-sm-6 col-md-6 col-lg-6 col-xl-3 wow fadeIn animated" data-wow-delay="600ms">
    				<div class="wd-news-box">
						<figure class="figure">
							<figcaption></figcaption>
							<img src="img/blog/news-img-2.jpg" class="figure-img img-fluid rounded" alt="news-img">
							<div class="wd-news-info">
								<div class="figure-caption"><a href="single-blog-with.php">Top 10 affiliate themes and templates you get from ThemeIM</a></div>
								<p class="wd-news-content">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Perspiciatis esse eligendi consectetur dicta minus placeat natus tempora dignissim</p>
								<a href="single-blog-with.php" class="badge badge-light wd-news-more-btn">Read More <i class="fa fa-arrow-right" aria-hidden="true"></i></a>
							</div>
    			...
    			<div class="col-12 col-sm-6 col-md-6 col-lg-6 col-xl-3 wow fadeIn animated" data-wow-delay="900ms">
    				<div class="wd-news-box">
						<figure class="figure">
							<figcaption></figcaption>
							<img src="img/blog/news-img-3.jpg" class="figure-img img-fluid rounded" alt="news-img">
							<div class="wd-news-info">
								<div class="figure-caption"><a href="single-blog-with.php">Make pixel perfect design and development from ThemeIM</a></div>
								<p class="wd-news-content">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Perspiciatis esse eligendi consectetur dicta minus placeat natus tempora dignissim</p>
								<a href="single-blog-with.php" class="badge badge-light wd-news-more-btn">Read More <i class="fa fa-arrow-right" aria-hidden="true"></i></a>
							</div>
							<span class="angle-right-to-left"></span>
    			...
    			<div class="col-12 col-sm-6 col-md-6 col-lg-6 col-xl-3 wow fadeIn animated" data-wow-delay="1200ms">
    				<div class="wd-news-box">
						<figure class="figure">
							<figcaption></figcaption>
							<img src="img/blog/news-img-4.jpg" class="figure-img img-fluid rounded" alt="news-img">
							<div class="wd-news-info">
								<div class="figure-caption"><a href="single-blog-with.php">Best US top catagories affiliate product list from BLURB Theme</a></div>
								<p class="wd-news-content">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Perspiciatis esse eligendi consectetur dicta minus placeat natus tempora dignissim</p>
								<a href="single-blog-with.php" class="badge badge-light wd-news-more-btn">Read More <i class="fa fa-arrow-right" aria-hidden="true"></i></a>
							</div>
							<span class="angle-left-to-right"></span>
    	...
    	<div class="container-fluid custom-width">
    		<div class="row">
    			<div class="col-6 col-md-6 col-lg-4 col-xl-2 wow fadeIn animated" data-wow-delay="0ms">
    				<img src="img/partner/partner-img-1.jpg" class="figure-img img-fluid" alt="partner-img">
    			</div>
    			<div class="col-6 col-md-6 col-lg-4 col-xl-2 wow fadeIn animated" data-wow-delay="300ms">
    				<img src="img/partner/partner-img-2.jpg" class="figure-img img-fluid" alt="partner-img">
    			</div>
    			<div class="col-6 col-md-6 col-lg-4 col-xl-2 wow fadeIn animated" data-wow-delay="600ms">
    				<img src="img/partner/partner-img-3.jpg" class="figure-img img-fluid" alt="partner-img">
    			</div>
    			<div class="col-6 col-md-6 col-lg-4 col-xl-2 wow fadeIn animated" data-wow-delay="900ms">
    				<img src="img/partner/partner-img-4.jpg" class="figure-img img-fluid" alt="partner-img">
    			</div>
    			<div class="col-6 col-md-6 col-lg-4 col-xl-2 wow fadeIn animated" data-wow-delay="1200ms">
    				<img src="img/partner/partner-img-5.jpg" class="figure-img img-fluid" alt="partner-img">
    			</div>
    			<div class="col-6 col-md-6 col-lg-4 col-xl-2 wow fadeIn animated" data-wow-delay="1400ms">
    				<img src="img/partner/partner-img-6.jpg" class="figure-img img-fluid" alt="partner-img">
    			</div>
    		</div>
    	</div>
    </section>
    			...
    			<div class="col-6 col-md-3 col-lg-2 footer-nav">
    				...
    				<div class="stores-list">
	    				...
	    				<ul>
	    					...
	    					<li><a href="shop-left-sidebar.php">Affiliate Market 6</a></li>
	    				</ul>
    				</div>
    			</div>
    			<div class="col-6 col-md-3 col-lg-2 footer-nav">
