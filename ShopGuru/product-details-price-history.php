   ...
   <!-- =========================
    ...
    <section class="product-details">
    	<div class="container">
			...
			<div class="row">
				<div class="col-12">
					<div class="wd-tab-section price-history-area">

						<div class="tab-pane" id="description-section">
						<div class="specifiction-section" id="specifiction">
							<div class="row">
							  <div class="col-12 col-md-4 price-history-section">
								  	<h2 class="price-history-title">Price History</h2>
								  	<p class="price-history-subtitle">Percent Change In Price</p>
									<div class="col-12">
										<div class="row">
											<div class="col-12 col-md-12 col-lg-12 col-xl-12 price-history-box">
							...
							<div class="col-12 col-md-8 tab-chart-bord">
